        ...
        <div className="container">
            <div className='team_inner'>
                <div className='team_top'>
                    <h2 className='main_title' data-aos="fade-left">Our top team</h2>
                    <p data-aos="fade-right">Learn more about how you can save our planet's nature.</p>
                </div>

                <div className='team_content'>
                    <div className='team_item team_item-1' data-aos="flip-left" data-aos-delay="300" data-aos-duration="2000" >
                        <img src={team1} />
                    </div>
                    <div className='team_item team_item-2'>
                        <div className='wrapp_svg line_first' data-aos="zoom-in" data-aos-delay="450" data-aos-duration="2000">
                            <svg  width="394" height="180" viewBox="0 0 394 180" fill="none" xmlns="http://www.w3.org/2000/svg" className=''>
                        ...
                        <div className='wrapp_img' data-aos="flip-up" data-aos-delay="600">
                            <img src={team2} />
                        </div>
                        <div className='wrapp_svg line_second' data-aos="zoom-in" data-aos-delay="750" data-aos-duration="2000">
                            <svg  width="394" height="180" viewBox="0 0 394 180" fill="none" xmlns="http://www.w3.org/2000/svg" className=''>
                    ...
                    <div className='team_item team_item-3' data-aos-delay="900" data-aos="flip-right" data-aos-duration="2000">
                        <img src={team3}  />
                    </div>
                </div>
            </div>

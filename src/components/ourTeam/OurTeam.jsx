        ...
        <div className="container">
            <div className='team_inner'>
                ...
                <div className='team_content'>
                    <div className='team_item team_item-1' data-aos="flip-left" data-aos-duration="2000" >
                        <img src={team1} />
                    </div>
                    <div className='team_item team_item-2'>
                        ...
                        <img data-aos="flip-up" src={team2} />
                    ...
                    <div className='team_item team_item-3' data-aos="flip-right" data-aos-duration="2000">
                        <img src={team3}  />
                    </div>
                </div>
            </div>
